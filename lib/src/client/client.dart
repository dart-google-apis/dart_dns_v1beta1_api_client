...
abstract class Client extends ClientBase {
  core.String basePath = "/dns/v1beta1/projects/";
  ...
  ManagedZonesResource_ get managedZones => new ManagedZonesResource_(this);
  ProjectsResource_ get projects => new ProjectsResource_(this);
  ResourceRecordSetsResource_ get resourceRecordSets => new ResourceRecordSetsResource_(this);
